(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".new-products__slider")) new swiper_core_Swiper(".new-products__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".our-blogs__slider")) new swiper_core_Swiper(".our-blogs__slider", {
                ...
                pagination: {
                    el: ".our-blogs__swiper-pagination",
                    clickable: true,
                    type: "bullets",
                ...
                navigation: {
                    prevEl: ".our-blogs__button-prev",
                    nextEl: ".our-blogs__button-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".catalog__slider")) new swiper_core_Swiper(".catalog__slider", {
                modules: [ Navigation, Pagination, Grid ],
                observer: true,
                observeParents: false,
                slidesPerView: 3,
            ...
            if (document.querySelector(".purchase-thumb__slider")) {
                const thumbsSwiper = new swiper_core_Swiper(".purchase-thumb__slider", {
                ...
                new swiper_core_Swiper(".purchase__slider", {
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".purchase__button-prev",
                        nextEl: ".purchase__button-next"
                    },
                    on: {
                        init: function(swiper) {}
                    }
        ...
        da.init();
        const element1 = document.getElementById("show");
        const element2 = document.getElementById("items");
        const element3 = document.getElementById("blog-show");
        const element4 = document.getElementById("blog-items");
        if (element1 && element2 && element3 && element4) {
            document.getElementById("show").onclick = function() {
                document.getElementById("items").classList.toggle("_show");
                document.getElementById("show").classList.toggle("_show");
            };
            document.getElementById("blog-show").onclick = function() {
                document.getElementById("blog-items").classList.toggle("_show");
                document.getElementById("blog-show").classList.toggle("_show");
            };
        } else console.log("Один из элементов не найден!");
        const buttonSize = document.querySelectorAll(".content-purchase__button-size");
        buttonSize.forEach((function(button) {
            button.addEventListener("click", (function() {
                buttonSize.forEach((function(btn) {
